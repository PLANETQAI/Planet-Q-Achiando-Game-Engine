...
export const GAME_REGISTRY = {
    ...
    'neon-hopper-01': {
        id: 'neon-hopper-01',
        name: 'Neon Hopper',
        description: 'High-speed precision trials. Double-jump over massive gaps to reach the summit!',
        category: 'platformer',
        tags: ['Precision', 'Parkour', 'Double Jump'],
        config: {
            player: { speed: 450, jumpForce: -600, gravity: 1200, maxJumps: 2, scale: 0.45, asset: 'shooter/cyber-city/cyborg-non-shooting-transparent.png' },
            level: { width: 4000, height: 600, spacing: 450, heightVariation: 150, platformWidthScale: 1.2 },
            vibe: 'neon'
        }
    },
    'cyber-quest-01': {
        id: 'cyber-quest-01',
        name: 'Cyber Quest',
        description: 'Traditional side-scrolling adventure through the neon megastructure. Tight jumps and dense platforms.',
        category: 'platformer',
        tags: ['Adventure', 'Exploration', 'Collectibles'],
        config: {
            player: { speed: 300, jumpForce: -750, gravity: 1600, maxJumps: 1, scale: 0.5, asset: 'shooter/cyber-city/ninja-non-shooting-transparent.png' },
            level: { width: 5000, height: 600, spacing: 250, heightVariation: 50, movingChance: 0.1, hazardChance: 0.1 },
            vibe: 'rainy-cyber'
        }
    },
    'gravity-runner-01': {
        ...
        name: 'Gravity Runner',
        description: 'Low-gravity moon jumps! Float gracefully across giant chasms.',
        category: 'platformer',
        tags: ['Floaty', 'Low Gravity', 'Space'],
        config: {
            player: { speed: 500, jumpForce: -400, gravity: 500, maxJumps: 1, scale: 0.4, asset: 'shooter/cyber-city/cyborg-non-shooting-transparent.png' },
            level: { width: 6000, height: 800, spacing: 550, heightVariation: 200, platformWidthScale: 1.5, movingChance: 0.05 },
            vibe: 'pulse'
        }
    },
    'void-jumper-01': {
        id: 'void-jumper-01',
        name: 'Void Jumper',
        description: 'Hardcore precision platforming. High gravity, tiny platforms, lots of hazards.',
        category: 'platformer',
        tags: ['Survival', 'Hardcore', 'Void'],
        config: {
            player: { speed: 320, jumpForce: -850, gravity: 2200, maxJumps: 1, scale: 0.45, asset: 'shooter/cyber-city/cyborg-non-shooting-transparent.png' },
            level: { width: 3500, height: 800, spacing: 300, heightVariation: 250, platformWidthScale: 0.6, hazardChance: 0.4, movingChance: 0.4 },
            vibe: 'dark-neon'
        }
    },
    'neon-match-01': {
    ...
    'cyber-pairs-01': {
        id: 'cyber-pairs-01',
        name: 'Cyber Pairs',
        description: 'Test your memory! Flip matching data fragments to clear the board.',
        category: 'puzzle',
        tags: ['Memory', 'Brain', 'Matching'],
        config: {
            grid: { width: 6, height: 4, tileSize: 85, types: 8 },
            type: 'memory-match',
            vibe: 'rainy-cyber',
            moves: 40
        }
    ...
    'defrag-sequence-01': {
        id: 'defrag-sequence-01',
        name: 'Defrag Sequence',
        description: 'Slide the sectors into their correct numerical sequence.',
        category: 'puzzle',
        tags: ['Slider', 'Logic', 'Strategy'],
        config: {
            grid: { width: 4, height: 4, tileSize: 100 },
            type: 'sliding-puzzle',
            vibe: 'neon',
            moves: 150
        }
    ...
    'neon-flow-01': {
        id: 'neon-flow-01',
        name: 'Neon Flow',
        description: 'Connect matching nodes with continuous pipes without crossing paths.',
        category: 'puzzle',
        tags: ['Connection', 'Paths', 'Logic'],
        config: {
            grid: { width: 6, height: 6, tileSize: 80 },
            type: 'line-connect',
            vibe: 'dark-neon',
            moves: 100
        }
    ...
    'neon-lexicon-01': {
        id: 'neon-lexicon-01',
        name: 'Neon Lexicon',
        description: 'Chain adjacent letters to form valid English words.',
        category: 'puzzle',
        tags: ['Word', 'Educational', 'Vocabulary'],
        config: {
            grid: { width: 8, height: 6, tileSize: 65 },
            type: 'word-connect',
            vibe: 'neon',
            moves: 30
        }
    ...
    'sum-to-ten-01': {
        id: 'sum-to-ten-01',
        name: 'Sum to Ten',
        description: 'Mathematical chaining! Drag across numbers that sum to exactly 10.',
        category: 'puzzle',
        tags: ['Math', 'Educational', 'Numbers'],
        config: {
            grid: { width: 7, height: 7, tileSize: 70 },
            type: 'number-sum',
            vibe: 'pulse',
            moves: 25
        }
    ...
    'cyber-search-01': {
        id: 'cyber-search-01',
        name: 'Cyber Search',
        description: 'Advanced Word Search! Find the target data strings hidden in the grid.',
        category: 'puzzle',
        tags: ['Word', 'Logic', 'Search'],
        config: {
            grid: { width: 10, height: 10, tileSize: 55 },
            type: 'word-search',
            vibe: 'neon',
            words: ["CYBER", "GRID", "FLOW", "DATA", "CORE", "SYNC", "NODE"],
            moves: 50
        }
    },
    'matrix-cross-01': {
        id: 'matrix-cross-01',
        name: 'Matrix Cross',
        description: 'Equation solving! Fill in the missing values to balance the matrix.',
        category: 'puzzle',
        tags: ['Math', 'Logic', 'Cross'],
        config: {
            grid: { width: 7, height: 7, tileSize: 70 },
            type: 'math-cross',
            vibe: 'pulse',
    ...
    'math-runner-01': {
        id: 'math-runner-01',
        name: 'Math Runner',
        description: 'Solve equations on the fly! Land on the platform with the correct answer.',
        category: 'platformer',
        tags: ['Math', 'Educational', 'Action'],
        config: {
            player: { speed: 350, jumpForce: -700, gravity: 1800, maxJumps: 2 },
            level: { width: 4000, height: 600, type: 'math-platformer' },
            vibe: 'neon'
        }
    },
    'cyber-collector-01': {
        id: 'cyber-collector-01',
        name: 'Cyber Collector',
        description: 'Collect all data fragments! Avoid the red spikes and reach the goal.',
        category: 'platformer',
        tags: ['Collect', 'Action', 'Brain'],
        config: {
            player: { speed: 400, jumpForce: -650, gravity: 1500 },
            level: { width: 3000, height: 600, type: 'collect-athon' },
            vibe: 'rainy-cyber'
        }
    }
};
